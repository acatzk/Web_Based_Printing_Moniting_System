...
<div class="wrapper">
    ...
    <div class="main-panel">
        ...
        <?php
          ...
          $statement = $pdo->prepare("SELECT * FROM user_files WHERE id = :id");
          $statement->execute(
                array(
                  ':id' => $_GET['remove']
                )
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <a href="files" class="close">&times;</a>
                                <h4 class="modal-title">Are you sure you want to delete '<?= $filename; ?>'? </h4>
                            </div>
                            <div class="modal-footer" style="text-align: center;">
                                <input type="submit" class="btn btn-info btn-fill btn-lg" name="btnYes" value="Yes"/>
                                <a href="files" class="btn btn-default btn-fill btn-lg">No</a>
                            </div>
                        </div>
                      </div>
                    </form>
